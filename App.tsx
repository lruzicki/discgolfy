  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <TouchableOpacity>
          <Ionicons name="menu" size={28} color="#E0E0E0" />
        </TouchableOpacity>
                ...
                <View style={styles.courseCardHeader}>
                  ...
                  <View style={styles.courseInfo}>
                    ...
                    <Text style={styles.courseMetaText}>
                      {course.location} • <MaterialCommunityIcons name="golf-tee" size={12} color="#A0A0A0" /> {course.holes}
                    </Text>
                  ...
                  <View style={styles.courseActionIcon}>
                    {isSelected ? (
                      <Ionicons name="checkmark-circle-outline" size={24} color="#90CAF9" />
                    ) : (
                      <Ionicons name="chevron-down" size={24} color="#A0A0A0" />
                    )}
                  </View>
                </View>
                ...
                {isSelected && (
                  <View style={styles.expandedContent}>
                    ...
                    <TouchableOpacity style={styles.dropdownSelector}>
                      ...
                      <Ionicons name="git-commit-outline" size={20} color="#A0A0A0" style={{ transform: [{ rotate: '90deg' }] }} />
                    </TouchableOpacity>

                    <TouchableOpacity style={styles.playButton}>
                      <Text style={styles.playButtonText}>Graj</Text>
                      <Ionicons name="play" size={18} color="#0D47A1" />
                    </TouchableOpacity>
                  </View>
                )}
              </TouchableOpacity>
      ...
      <View style={styles.bottomNav}>
        <TouchableOpacity style={styles.navItem}>
          <Ionicons name="compass-outline" size={24} color="#90CAF9" />
          <Text style={[styles.navText, { color: '#90CAF9' }]}>Courses</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.navItem}>
          <Ionicons name="play-circle-outline" size={24} color="#A0A0A0" />
          <Text style={styles.navText}>Play</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.navItem}>
          <Ionicons name="podium-outline" size={24} color="#A0A0A0" />
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: '#151517', // Match dark background
  },
  header: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  headerTitle: {
    color: '#90CAF9', // Light blue text for logo
    fontSize: 20,
    fontWeight: '700',
  },
  scrollContent: {
  ...
  playButtonText: {
    color: '#0D47A1', // Dark blue text for button
    fontSize: 18,
    fontWeight: '700',
  },
  bottomNav: {
