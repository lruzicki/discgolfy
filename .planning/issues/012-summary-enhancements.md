...
## Acceptance criteria
- [ ] A sorted leaderboard (best score to worst) is visible in all summary views.
- [ ] Scores are clearly displayed as "Total Strokes (Relative to PAR)".
- [ ] Background color of the summary tab matches the rest of the application theme.
